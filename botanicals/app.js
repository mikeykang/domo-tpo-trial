...
(function () {
  ...
  app.appendChild($(
    ...
    '<div class="hint">미스트 조사에서 쿨링 언급은 한국 3.7% 대 일본 0.3%로 한국 쪽 수요였다. TRPM8(냉감 수용체) 작동이 앞, 나머지 냉감·겸용이 뒤.</div></div>' +
  ...
  app.appendChild($(
    ...
    '<b>맥락.</b> 이 조사는 미스트 카테고리 조사에서 나온 두 사실에서 출발했다: 쿨링 언급은 한국 리뷰 3.7% 대 일본 0.3%로 한국 쪽 수요고, 진정은 카테고리의 기본 언어다. 원료 선정 단계의 후보 풀로 쓰라고 만든 표다.' +
    '</div>').firstChild);
})();
