(function () {
  ...
  E.push('<div class="foot">' +
    ...
    '<b>@cosme 범위</b> 장문 대조용 @cosme는 <b>COSRX · Celladix · FEEV 3종만</b> 수집했다 (' + n(D.corpus.jpCosme) + '건). Anua · SKIN1004는 개별 후기 페이지 단계에서 사이트 스로틀에 걸려 이번 스냅샷에서 빠졌다. 그래서 @cosme 열은 「큐텐에서 안 보이는 것이 매체 탓인지 진짜 부재인지」를 가르는 보조 지표로만 읽어야 하고, 일본 5종 전체를 대표하지 않는다.<br>' +
