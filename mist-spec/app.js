(function () {
  ...
  var KO_NOTE = '일본어 아래 한국어 전문 번역 (사람이 옮김, 기계번역 없음)';
  ...
  E.push('<div class="panel"><div class="ph"><h3>진단 10 · 한국에서 뜨는 컨셉 (최근 12개월 대 그 이전, 길이 보정)' +
    ...
    '<p>뜨는 쪽 1위가 <b>아벤느 「그냥 물 논쟁」 1.79배</b>(5.2% → 9.4%)다 — 미스트가 물이냐 아니냐를 두고 싸우는 말이 지금 가장 빠르게 큰다. 2위는 <b>차앤박 「메이크업 위에 뿌려도 뭉치지 않는다」 1.44배</b>로, 후보 3의 수정화장 축이 한국에서도 자라는 중이라는 신호다. 지는 쪽은 전부 브랜드 카피다: 차앤박 「Solution 01 영양보습」 0.52배 · 아벤느 「10초에 1개씩 판매되는 글로벌 베스트셀러」 0.60배. 브랜드가 상세에 크게 쓴 말일수록 리뷰에서 빠르게 사라진다.</p></div>');
